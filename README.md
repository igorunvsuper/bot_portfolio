...
| [lead-bot.json](workflows/lead-bot.json) | Бот приёма заявок: параллельно отвечает клиенту («Спасибо за заявку, свяжемся») и шлёт админу уведомление с именем, username, Chat ID и текстом. Готовый шаблон под салоны, автосервисы, стоматологии |
